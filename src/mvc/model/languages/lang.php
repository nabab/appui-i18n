...
if ( $lang = $model->data['lang'] ){
  ...
  $dropdown_langs = $model->get_model('internationalization/languages/statistic_tab')['dropdown_langs'];
  //source of dropdown of translation languages
  $source_dd_langs = $model->get_model('internationalization/languages/statistic_tab')['source_dd_langs'];
